...
See [this issue regarding project references](https://github.com/typescript-eslint/typescript-eslint/issues/2094 "typescript-eslint issue 2094 (project references support)") for more details.
